...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceClasses.set ("assets/data/fonts/bioliquid-regular.ttf", NME_assets_data_fonts_bioliquid_regular_ttf);
			resourceTypes.set ("assets/data/fonts/bioliquid-regular.ttf", "font");
			resourceClasses.set ("assets/data/fonts/bioliquid.zip", NME_assets_data_fonts_bioliquid_zip);
			resourceTypes.set ("assets/data/fonts/bioliquid.zip", "binary");
			resourceClasses.set ("assets/data/fonts/nasalization-rg.ttf", NME_assets_data_fonts_nasalization_rg_ttf);
			resourceTypes.set ("assets/data/fonts/nasalization-rg.ttf", "font");
			resourceClasses.set ("assets/data/fonts/nasalization.jpg", NME_assets_data_fonts_nasalization_jpg);
			resourceTypes.set ("assets/data/fonts/nasalization.jpg", "image");
			resourceClasses.set ("assets/data/fonts/nasalization.zip", NME_assets_data_fonts_nasalization_zip);
			resourceTypes.set ("assets/data/fonts/nasalization.zip", "binary");
			resourceClasses.set ("assets/data/fonts/read this . . . really read it.pdf", NME_assets_data_fonts_read_this_______really_read_it_pdf);
			resourceTypes.set ("assets/data/fonts/read this . . . really read it.pdf", "text");
			resourceClasses.set ("assets/data/fonts/read this first.html", NME_assets_data_fonts_read_this_first_html);
			resourceTypes.set ("assets/data/fonts/read this first.html", "text");
			resourceClasses.set ("assets/data/fonts/westminster.ttf", NME_assets_data_fonts_westminster_ttf);
			resourceTypes.set ("assets/data/fonts/westminster.ttf", "font");
			resourceClasses.set ("assets/data/handle.png", NME_assets_data_handle_png);
			resourceTypes.set ("assets/data/handle.png", "image");
			resourceClasses.set ("assets/data/Lander.png", NME_assets_data_lander_png);
